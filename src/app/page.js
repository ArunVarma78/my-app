...
const Section1 = ({ scrollYProgress }) => {
  ...
  return (
    <motion.div
      style={{ scale, rotate }}
      className="sticky top-0 h-screen bg-[#0e285c] text-white flex flex-col justify-center px-20"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl mb-12 max-w-2xl">
          I create beautiful, responsive websites with modern technologies and
...
const Section2 = ({ scrollYProgress }) => {
  ...
  return (
    <motion.div
      style={{ scale, rotate }}
      className="relative w-[100vw] h-[100vh] bg-white flex"
    >
      ...
      <div className="w-1/2 p-12 flex flex-col justify-center">
        ...
        <div className="space-y-8">
          <div className="project">
            <h3 className="text-xl font-bold text-[#0e285c]">
              E-Commerce Platform
            </h3>
            <p className="text-gray-700 mb-2">
              A full-stack shopping platform built with Next.js, MongoDB, and
              Stripe integration.
            </p>
          </div>
          ...
          <div className="project">
            ...
            <p className="text-gray-700 mb-2">
              Dynamic weather application with OpenWeather API and geolocation
              features.
            </p>
          </div>
        </div>
      ...
      <div className="w-1/2 p-12 flex flex-col justify-center">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-yellow-400 text-[#0e285c] px-8 py-3 rounded-lg w-fit font-bold hover:bg-yellow-300 transition-colors"
          >
            Send Message
          </button>
